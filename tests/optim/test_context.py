...
class TestOptimizationContext(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reference = ReferenceTrajectory(hand, obj, contacts)
    ...
    def test_contact_indices_from_reference(self):
        """Test that contact indices are set from reference."""
        ctx = OptimizationContext(
            self.hand_model,
            self.object_model,
            reference=self.reference,
        ...
        self.assertTrue(torch.equal(ctx.contact_indices, self.reference.contact_indices))

    def test_set_contact_indices(self):
        """Test manually setting contact indices."""
